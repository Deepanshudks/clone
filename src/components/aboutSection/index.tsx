    ...
    <div className="p-8 flex flex-col items-center justify-center gap-18">
      <div className="flex items-center justify-center">
        ...
        >
          ...
          excepturi, laborum recusandae eum ut id iure cumque molestias unde eos
          provident totam beatae! Consectetur cupiditate, blanditiis eos, eum
          eveniet a officiis tempore quia animi veritatis, neque odio aut modi
          nihil laudantium sunt! Fugit aut voluptate, aperiam quo ipsam
